...
| W-C W6 (Sol using For) | W-C W1 완료 | ✅ **LANDED 2026-05-12** (V0 binding + V1.0-V1.13 14-tier dispatch + V1.14-V1.18 family validations / fixes + V1.19-V1.21 named-scope captures + **V1.22 modifier body scope captures** (runModifierMeta walker + Container.modifier qname + nearestFunctionQnameAndStart 가 modifier_definition 인식); constructor_definition / fallback_receive / block-scoped shadowing / module-import V1.23+; free-fn / file-level grammar-blocked) |
