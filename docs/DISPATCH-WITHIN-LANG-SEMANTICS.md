...
| W-C W6 (Sol using For) | W-C W1 완료 | ✅ **LANDED 2026-05-12** (V0 binding + V1.0-V1.12 13-tier dispatch — V1.0-V1.11 + **generic member-chain walker V1.12 arbitrary depth**; multi-return tuple + this-prefixed nested V1.13+; free-fn / file-level grammar-blocked) |
