...
| W-C W6 (Sol using For) | W-C W1 완료 | ✅ **LANDED 2026-05-12** (V0 binding + V1.0-V1.13 14-tier dispatch + V1.14 cross-file struct validation + V1.15 single-return local-var receiver + **V1.16 multi-return tuple destructuring** (LHS explicit types, V1.15 localVarTypes 인프라 재사용); pre-declared identifier-slot V1.17+; free-fn / file-level grammar-blocked) |
