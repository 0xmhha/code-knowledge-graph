...
| W-C W6 (Sol using For) | W-C W1 완료 | ✅ **LANDED 2026-05-12** (V0 binding + V1.0-V1.13 14-tier dispatch + V1.14 cross-file struct validation + **V1.15 single-return local-var receiver** — localVarTypes 인덱스 + lookupReceiverType 3-tier fallback (state-var → param → local-var); multi-return tuple V1.16+; free-fn / file-level grammar-blocked) |
