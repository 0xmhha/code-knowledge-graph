...
| W-C W6 (Sol using For) | W-C W1 완료 | ✅ **LANDED 2026-05-12** (V0 binding + V1.0-V1.13 14-tier dispatch + V1.14-V1.18 family validations / fixes + V1.19-V1.21 named-scope captures + V1.22-V1.24 callable kinds + V1.25 free function regression guard + **V1.26 abstract contract body scope regression guard**; block-scoped shadowing / module-import V1.27+; free-fn alias / file-level grammar-blocked) |
