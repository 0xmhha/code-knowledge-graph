...
> emit. W6 V1.0~V1.10 (11-tier dispatch resolution) ✅ **LANDED
...
> / this-receiver (V1.9) / **struct-field receiver
> `<obj>.<field>.<method>` (V1.10)**.
...
> Multi-return tuple destructuring + nested struct field receivers 만
> V1.11+ follow-up.
