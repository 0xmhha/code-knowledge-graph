...
> emit. W6 V1.0~V1.11 (12-tier dispatch resolution) ✅ **LANDED
...
> / this-receiver (V1.9) / struct-field receiver (V1.10) /
> **nested struct field `<obj>.<field1>.<field2>.<method>` (V1.11)**.
...
> Multi-return tuple destructuring + depth ≥ 3 nested struct 만 V1.12+
> follow-up.
