...
> emit. W6 V1.0~V1.9 (10-tier dispatch resolution) ✅ **LANDED
...
> / **this-receiver `this.<state-var>.<method>` (V1.9)**.
...
> struct-field receivers (`info.amount.foo()`) + multi-return tuple
> destructuring 만 V1.10+ follow-up.
