...
> emit. W6 V1.0~V1.6 (7-tier dispatch resolution) ✅ **LANDED
...
> chaining `<fn>().<fn>().<method>` (V1.5) / deep cross-contract chain
> `<obj>.<fn>().<fn>().<method>` (V1.6).
...
> depth ≥ 3 generic chains + multi-return tuple slot 만 V1.7+
> follow-up.
